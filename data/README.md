...
- 106 年的資料來源來自 `nlma.gov.tw` 為內政部國土管理署
- 107 年以後的資料來自於 `pip.moi.gov.tw` 為內政部不動產資訊平台

| 西元   | 本地備份                               | 原始資料來源                                                                                          |
| ------ | -------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| 202412 | [11312](./pdf_SocialHousing/11312.pdf) | https://pip.moi.gov.tw/Upload/File/SocialHousing/1140107-社會住宅興辦案件執行情形彙整.pdf             |
...
- 202303(11203)起, 再次開始揭露 `規劃中`
- 202303(11203)起, 開始揭露 `既有`, 並且改以摘要表格方式揭露
- 202411(11311), 將六都以外的其他縣市全數揭露
- 202412(11312), 將 `既有` 併入到 `新完工` (並且 pdf 欄位更名為 `已完工`)
